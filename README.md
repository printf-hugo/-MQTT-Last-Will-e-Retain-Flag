...
LWT: Evita a leitura de dados falsos ou defasados. Se um sensor de temperatura trava, o sistema sabe instantaneamente que o dispositivo está offline e invalida os dados anteriores.
